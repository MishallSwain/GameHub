 ...
 $(function (){
	...
	function fullChartf(){
		...
		setTimeout(function() {
		 ...
		 chart1 = new CanvasJS.Chart("kill-deathf",
		{
		  animationEnabled: true,
		  colorSet: "shades",
		  backgroundColor: "rgba(0,0,0,0.6)",
	   ...
	   document.getElementById("kdf").innerHTML = (kills/deaths*1.00).toFixed(2);
	   ratioColor("kdf");
	   
		chart2 = new CanvasJS.Chart("win-lossf",
		{
		  animationEnabled: true,
		  colorSet: "shades",
		  backgroundColor: "rgba(0,0,0,0.6)",
	   ...
	   document.getElementById("wlf").innerHTML = (wins/loss*1.00).toFixed(2);
	   ratioColor("wlf");
	   
		chart2m = new CanvasJS.Chart("match-win-lossf",
		{
		  animationEnabled: true,
		  colorSet: "shades",
		  backgroundColor: "rgba(0,0,0,0.6)",
		...
		document.getElementById("timef").innerHTML = (time/60/60).toFixed(2)+"hr";
		document.getElementById("hostagef").innerHTML = (hostages); 
		document.getElementById("headshotf").innerHTML = (headshots);
		document.getElementById("windowf").innerHTML = (windows);
		document.getElementById("dominationf").innerHTML = (domination);
		document.getElementById("mvpf").innerHTML = (mvps);
		document.getElementById("dom-overf").innerHTML = (dom_overkill);
		document.getElementById("revengef").innerHTML = (revenge);
		document.getElementById("pistolf").innerHTML = (pistolRounds);
		document.getElementById("decalf").innerHTML = (decal); 
		//document.getElementById("damage").innerHTML = (damage);
		if(damage>1000000){
			document.getElementById("damagef").innerHTML = (damage/1000000).toFixed(2)+"mil";
		}else if(money>1000){
			document.getElementById("damagef").innerHTML = (damage/1000).toFixed(2)+"k";
		}else{
			document.getElementById("damagef").innerHTML = (damage);
		}
		//document.getElementById("money").innerHTML = (money);
		if(money>1000000){
			document.getElementById("moneyf").innerHTML = (money/1000000).toFixed(2)+"mil";
		}else if(money>1000){
			document.getElementById("moneyf").innerHTML = (money/1000).toFixed(2)+"k";
		}else{
			document.getElementById("money").innerHTML = (money);
		}
		
	   document.getElementById("mwlf").innerHTML = (m_won/(m_played - m_won)*1.00).toFixed(2);
	   ratioColor("mwlf");

		 chart3 = new CanvasJS.Chart("bombDPf",
		{
		  animationEnabled: true,
		  colorSet: "shades",
		  backgroundColor: "rgba(0,0,0,0.6)",
	...
	if(customidf!=false){
		$.ajax({
			 dataType: 'JSONP',
			url: `https://json2jsonp.com/?url=${encodeURIComponent(`http://api.steampowered.com/ISteamUser/ResolveVanityURL/v0001/?key=CF287EF9D049517AD75478BD1F56D778&vanityurl=${customidf}`)}`,
			jsonCallback: 'callback',
			type : 'GET',
		...
		success: function printData(datas) {
			$.each(datas, function(key , value){
				if(key === "avatarfull"){
					...
					//document.getElementById("nickname").innerHTML = value + "'s stats";
...
function profileinfof(id){
	$.ajax({
		...
		success: function printData(datas) {
			$.each(datas, function(key , value){
				if(key === "avatarfull"){
					document.getElementById("pfpf").src = value;
					return;
				}
				else if(key === "personaname"){
					//document.getElementById("nicknamef").innerHTML = value + "'s stats";
					//$('#nickname').append(value);
					return;
				}
				else if(typeof value === 'object'){
